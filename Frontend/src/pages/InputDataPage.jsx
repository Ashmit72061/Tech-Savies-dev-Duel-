                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="relative">
                                <select className="w-full rounded-lg border-2 border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 text-gray-900 dark:text-white h-12 px-4 pr-10 appearance-none focus:ring-2 focus:ring-primary focus:border-primary">
