                        ...
                        {['profile', 'security', 'notifications', 'privacy'].map((tab) => (
                            ...
                            >
                                <Icon name={
                                    tab === 'profile' ? 'person' :
                                        tab === 'security' ? 'lock' :
                                            tab === 'notifications' ? 'notifications' : 'visibility_off'
                                } size={20} />
                                {tab}
                            </button>
                        ))}
                        ...
                        <Card>
                            <div className="flex flex-col md:flex-row items-center gap-6 mb-8">
                                <div className="relative">
                                    ...
                                    <button className="absolute bottom-0 right-0 p-1.5 bg-primary rounded-full border-2 border-white dark:border-surface-dark text-black">
