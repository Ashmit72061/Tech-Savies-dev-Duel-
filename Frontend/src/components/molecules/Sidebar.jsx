                ...
                <div className="h-full flex flex-col justify-between p-4">
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="flex items-center gap-3 px-2 h-12">
                            ...
                            <div>
                                <h1 className="text-lg font-bold tracking-tight text-text-main dark:text-white">EcoScore</h1>
                                <p className="text-xs text-text-secondary uppercase tracking-wider">{role} Portal</p>
                            </div>
                        </div>
                    ...
                    <div className="border-t border-gray-100 dark:border-gray-800 pt-4">
                        <Link to={role === 'admin' ? '/admin/login' : '/resident/login'} className="flex items-center gap-3 px-3 py-2 rounded-lg text-red-600 hover:bg-red-50 dark:hover:bg-red-900/10 transition-colors">
                            <Icon name="logout" />
